...
FeverTokens API
- API version: 1.1.0
  - Build date: 2024-03-09T15:30:38.523246800+01:00[GMT+01:00]

fevertokens-api

  For more information, please visit [https://fevertokens.io](https://fevertokens.io)
...
------------ | ------------- | ------------- | -------------
*ProjectsApi* | [**projectsGet**](docs/ProjectsApi.md#projectsGet) | **GET** /projects | Retrieve a list of projects
